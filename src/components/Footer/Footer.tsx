...
const NAV_SECTIONS = [
  ...
  { id: 'professional-experiences', icon: 'fas fa-briefcase', labelKey: 'navbar.professional_experiences' },
  { id: 'projects',      icon: 'fas fa-folder-open',  labelKey: 'navbar.projects' },
  { id: 'github-dashboard', icon: 'fab fa-github', labelKey: 'navbar.github_dashboard' },
];
